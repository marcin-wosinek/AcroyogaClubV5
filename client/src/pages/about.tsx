        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            ...
            <div className="text-center space-y-4">
              ...
              <p
                className={`text-xl lg:text-2xl ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}
              >
            ...
            >
              <CardContent className="p-6 lg:p-8">
                ...
                >
                  Acroyoga is a beautiful practice that combines the wisdom of yoga, the dynamic
                  power of acrobatics, and the loving-kindness of healing arts. It's about
                  connection, trust, and playful exploration of movement with partners. Whether
                  you're flying through the air or providing a stable base, every role teaches us
                  something valuable about ourselves and others.
                </p>
              </CardContent>
            </Card>
            ...
            >
              <CardContent className="p-6 lg:p-8">
                ...
                >
                  ...
                  growth, and the magic that happens when we support each other both on and off the
                  mat.
                </p>
